 ...
 * security returns an empty result set, transaction-scoped row-level security rejects
 * tenant-scoped work outside a transaction while leaving shared registry reads available,
 * schema-per-tenant raises an unresolved-relation error, and
